...
//
//
//    public Book saveBook(String title, int price, String description, int nbOfPages, String isbn, boolean illustration) throws Exception {
...
//        return null;
//    }
//    public void changeBook(Long id, String title, int price, String description, int nbOfPages, String isbn, boolean illustration) throws Exception {
